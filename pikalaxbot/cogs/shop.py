...
class Shop(BaseCog):
    ...
    @mart.command()
    async def buy(self, ctx: MyContext, item: PokeApi.Item, quantity: int_range(0, 999)):
    ...
    @mart.command()
    async def sell(self, ctx: MyContext, item: PokeApi.Item, quantity: int_range(0, 999)):
